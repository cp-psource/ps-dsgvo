...
Documentation
[https://www.psdsgvo.com/documentation/](https://www.psdsgvo.com/documentation/ "WP GDPR Compliance documentation")

== Installation ==

1. Upload the plugin files to the `/wp-content/plugins/ps-dsgvo-tool` directory, or install the plugin through the WordPress plugins screen directly.
2. Activate the plugin through the 'Plugins' screen in WordPress
3. Go to Tools -> WP GDPR Compliance

== Frequently Asked Questions ==

You'll find answers to many of your questions on [https://www.psdsgvo.com/faq/](https://www.psdsgvo.com/faq/ "Frequently Asked Questions")
...
* Bugfix: WP Registration integration now also works on MultiSite, accepted consent on registering gets added to the 'psdsgvo_log' table.
...
* Show a message for the administrators when using the [psdsgvo_consents_settings_link] and no active consents are added.
...
* Added shortcode [psdsgvo_consents_settings_link]. This will create a link to the consent settings.
...
* Added translatable 'Ja' and 'No' strings.
...
* Added 'noopener noreferrer' to the Datenschutz-Bestimmungen link.
